        ...
        <div className="profile-card full-width">
          ...
          <div className="preference-item">
            <div className="preference-content">
              ...
              <p className="preference-desc">Get notified about ratings, feedback, and updates</p>
            </div>
          </div>
          <div className="preference-item">
            <div className="preference-content">
              <label>
                <input type="checkbox" defaultChecked /> Show dashboard tips
              </label>
              <p className="preference-desc">Display helpful tips on the worker dashboard</p>
            </div>
          </div>
          <div className="preference-item">
            <div className="preference-content">
